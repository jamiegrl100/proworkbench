...
const backupPath = path.join(root, "ui", "src", `App.broken.${Date.now()}.tsx`);

const content = `// ui/src/App.tsx
...
if (fs.existsSync(appPath)) {
  ...
  console.log("Backed up broken App.tsx to:", backupPath);
}

fs.writeFileSync(appPath, content, "utf8");
console.log("Wrote clean App.tsx to:", appPath);
